...
public class BinarySearchTree<E extends Comparable<E>>
    ...
    private E findLargestChild(Node<E> parent) {
        ...
        if (parent.right.right == null) {
            //right child is the inorder predecessor
        ...
        if (compResult < 0) {
            ...
            if (localRoot.left == null) {
                ...
                if(localRoot.right.left == null){
                    //if localRoot.right is the smallestChild , return it.
                    return localRoot.right;
                }else {
                    //find the smallestChild in the right subtree and replace the root value with this smallest value
    ...
    private E findSmallestChild(Node<E> parent) {
        if(parent.left.left == null){
            //if parent is the smallest node, get its value and promote its right child(could be null).
            E item = parent.left.data;
    ...
    public boolean contains(E target) {
        ...
        int index = currentRoot.data.compareTo(target);
        while (index != 0){
            if (index < 0){
            ...
            index = currentRoot.data.compareTo(target);
        }
        return true;
    }
