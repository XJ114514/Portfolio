 ...
 *
 * @author Koffman and Wolfgang & Cindy & Xu Jiang
 *
 */
public class BinaryTree<E> {
    ...
    public static void main(String[] args) {
        ...
        Node<Character> subRight = new Node<>('/');
        subRight.left = new Node<Character>('a');
        subRight.right = new Node<Character>('b');

        Node<Character> tree = new Node<>('*');
        tree.left = plus;
        tree.right = subRight;
        BinaryTree<Character> binaryTree01 = new BinaryTree<>(tree);
    ...
    public String preOrderTraverse() {
        ...
        preOrderTraverse(root,stringBuilder);
    ...
    private void preOrderTraverse(Node<E> currentRoot, StringBuilder currentResultSB) {
        currentResultSB.append(currentRoot.data+"  ");
    ...
    public String inOrderTraverse() {
        StringBuilder stringBuilder = new StringBuilder();
        inOrderTraverse(root,stringBuilder);
        return stringBuilder.toString();
    }
    ...
    private int size(Node<E> currentRoot) {
        ...
        int subRight = 0;
        if(currentRoot.left != null){
            subLeft = size(currentRoot.left);
        }
        if(currentRoot.right != null){
            subRight = size(currentRoot.right);
        }
        return 1+subLeft+subRight;
    }    
    ...
    private int height(Node<E> currentRoot) {
        ...
        int subRight = 0;
        if(currentRoot.left != null){
            subLeft = height(currentRoot.left);
        }
        if(currentRoot.right != null){
            subRight = height(currentRoot.right);
        }
        int max = subLeft;
        if(max <subRight){
            max = subRight;
